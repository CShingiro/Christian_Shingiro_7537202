...
--
-- Host: 127.0.0.1    Database: dbtask7
-- ------------------------------------------------------
...
CREATE USER administrator@localhost IDENTIFIED BY 'task7';
...
CREATE TABLE `dbtable` (
  ...
  `confirmedpass` varchar(45) DEFAULT NULL,
...
-- Dump completed on 2021-12-09 22:49:53
